...
echo "
    <li class='nav-item'><a href='?module=listdomain' id='font-grey' class='nav-link' "; if($module=='listdomain'){echo "style='color:white'";} echo ">List Domains</a></li>
  ...
  <li class='nav-item'><a href='?module=addforwarder' id='font-grey' class='nav-link' "; if($module=='addforwarder'){echo "style='color:white'";} echo ">Add Forwarders</a></li>
  <li class='nav-item'><a href='?module=trace' id='font-grey' class='nav-link' "; if($module=='trace'){echo "style='color:white'";} echo ">Trace</a></li>
  <li class='nav-item'><a href='?module=update' id='font-grey' class='nav-link' "; if($module=='update'){echo "style='color:white'";} echo ">Check For Update</a></li>
...
echo "<iframe src='".$module.".php' style='display:block;border:0px;width:100%;height:83%;align:center'></iframe>";
